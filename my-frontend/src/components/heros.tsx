...
export default function HeroUI() {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/20 via-black to-blue-600/20" />
      ...
      <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-blue-900/30 to-transparent pointer-events-none" />
    </div>
  );
}