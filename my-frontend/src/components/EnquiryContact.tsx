...
import webDevAPI from '../api/api';

interface WebDevServicePopupProps {
  isOpen?: boolean;
  onClose?: () => void;
  autoOpen?: boolean;
...
export default function WebDevServicePopup({ 
  ...
  // Auto-open functionality (only if not controlled and autoOpen is true)
  useEffect(() => {
    if (controlledIsOpen === undefined && autoOpen) {
      const timer = setTimeout(() => {
        setInternalIsOpen(true);
      }, autoOpenDelay);
      return () => clearTimeout(timer);
    }
  }, [controlledIsOpen, autoOpen, autoOpenDelay]);
